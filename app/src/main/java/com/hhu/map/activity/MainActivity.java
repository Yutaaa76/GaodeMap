...
import com.hhu.map.utils.PointsUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aMap.setMapType(AMap.MAP_TYPE_NORMAL);//地图模式可选类型：MAP_TYPE_NORMAL,MAP_TYPE_SATELLITE,MAP_TYPE_NIGHT
    ...
    private void initMoveMarker() {
        ...
        // 设置滑动的图标
        moveMarker.setDescriptor(BitmapDescriptorFactory.fromResource(R.drawable.icon_car));
       ...
       //moveMarker.setPoints(points);//设置平滑移动的轨迹list
        moveMarker.setTotalDuration(20);//设置平滑移动的总时间
    ...
    public void onClick( View view ) {
        if (mMarkerStatus == START_STATUS) {
            ...
            LatLng latLng = new LatLng(39.979285,116.347586);
            cameraUpdate= CameraUpdateFactory.newCameraPosition(new CameraPosition(latLng,17,0,0));
            ...
            moveMarker.setPosition(new LatLng(39.979285, 116.347586));
            List<LatLng> points = readLatLngs();
            moveMarker.getMarker().showInfoWindow();
